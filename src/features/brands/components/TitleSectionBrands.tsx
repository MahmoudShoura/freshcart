...
export default function TitleSectionBrands() {
  return (
    <>
      <div className="h-full flex items-center justify-center  ">
        <div className="overlay py-14 px-8 text-white p-4 w-full h-full content-center bg-linear-to-r from-purple-600/80 to-purple-800/90">
          <nav className="flex items-center gap-2 text-sm text-gray-500 mb-6">
            ...
            <span className="text-white font-bold text-md ">Brands</span>
          </nav>
